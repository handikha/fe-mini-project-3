...
export default function LoadingCards() {
  ...
  return loadingItems.map((_, index) => (
    <div className="flex h-[320px] w-full animate-pulse flex-col gap-3 rounded-md p-4 shadow-md duration-300 hover:scale-[103%] hover:shadow-xl dark:bg-slate-800/60">
